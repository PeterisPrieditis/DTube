...
{#if channel}
        ...
        <div class="container mx-auto">
            <div class="flex justify-between items-center py-4 px-16">
                ...
                <div class="text-grey-dark">
                    <button class="appearance-none px-3 py-2 bg-grey-light uppercase text-gray-700 text-sm mr-4">Subscribed 126K</button>
                    <span><i class="fa fa-bell fa-lg" aria-hidden="true"></i></span>
                </div>
            </div>
            <div class="px-16">
                <ul class="list-reset flex">
                    <li class="text-center py-3 px-8 border-b-2 border-solid border-gray-500"><a href="#" class="text-black">Home</a></li>
    ...
    <div class="container mx-auto flex">
                ...
                <div class="flex">
                    ...
                    <div class="w-1/4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 text-xs mb-1">Fun Fun Function</p>
                            <p class="text-gray-700 text-xs">
                                <span>186 views</span>
                                <span>&middot;</span>
                ...
                <div class="flex mb-4 relative">
                    ...
                    <div class="flex-1 mr-1">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-2 font-hairline text-sm text-gray-700">
                                Fun Fun Function
                                <span class="w-3 h-3 text-white inline-block text-center rounded-full bg-grey-dark text-2xs">&#10003;</span>
                            </p>
                            <p class="mt-1 font-hairline text-xs text-gray-700">
                                336K views &middot; 2 years ago
                            </p>
                            <p class="inline block p-1 text-gray-700 bg-slate-300 font-hairline text-2xs">
                                CC
                            </p>
                        </div>
                    </div>
        ...
        <div class="w-1/4 py-6">
            <div class="border-b">
                <p class="text-gray-700 uppercase text-sm mb-6">Other channels I like</p>
                <ul class="list-reset">
                    <li class="mb-6">
                        ...
                        <button class="appearance-none p-2 bg-grey-light uppercase text-gray-700 text-xs mr-4">Subscribe</button>
                    </li>
                    <li class="mb-6">
                        <span class="flex items-center mb-2">
            ...
            <div class="py-6">
                <p class="text-gray-700 uppercase text-sm mb-6">RELATED CHANNELS</p>
                <ul class="list-reset">
                    <li class="mb-6">
                        <span class="flex items-center mb-2">
